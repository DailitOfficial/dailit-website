        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/50 p-6 sm:p-8">
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="text-xs text-gray-600 space-y-1">
              <p><span className="font-medium">Email:</span> admin@dailit.com</p>
              <p><span className="font-medium">Password:</span> You need to set this up in Supabase Auth</p>
            </div>
          </div>
        </div>
