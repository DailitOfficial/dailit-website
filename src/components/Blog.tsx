              ...
              >
                <Card variant="elevated" className="h-full hover:shadow-xl transition-shadow">
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="bg-primary/10 text-primary px-2 py-1 rounded text-xs font-bold mb-3 inline-block">
                      {resource.type}
                    </div>
                    ...
                    <Button size="sm" className="w-full" href={resource.downloadUrl}>
                      Download Free
                    </Button>
                  </CardContent>
                </Card>
            ...
            <CardContent className="p-8 lg:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-lg text-gray-900 border-0 focus:ring-2 focus:ring-white/30"
                />
