            ...
            {managers.map((manager) => (
              <tr key={manager.id}>
                <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                  <div>
                    <div className="text-sm font-medium text-gray-900 truncate max-w-32 sm:max-w-none">{manager.name}</div>
                    <div className="text-xs text-gray-400 sm:hidden mt-1 truncate max-w-32">{manager.email}</div>
                    <div className="text-xs text-gray-400 md:hidden mt-1">{manager.phone || '-'}</div>
                  </div>
                </td>
                <td className="px-3 sm:px-6 py-4 whitespace-nowrap hidden sm:table-cell">
                  <div className="text-sm text-gray-900 truncate max-w-48">{manager.email}</div>
                </td>
